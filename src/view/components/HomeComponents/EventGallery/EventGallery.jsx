        ...
        <div className="container my-5 bg-dark">
            <div className="row p-5">
                ...
                <div className="col-md-4 col-12 eventgallery-right">
                    <div className="p-4 bg-light shadow-sm h-75 lh-lg">
                        <h2 className="fw-bold heading-font">Subscribe Now</h2>
                        <p className="heading-font fw-bold lh-lg fs-5">
                        ...
                        <button className="btn btn-primary my-3">Learn About</button>
                        <p className="mt-2 heading-font">
