...
// import { selectOurProgramData, selectOurProgramLoading, selectOurProgramError } from '../../redux/slice/ourProgramSlice/ourProgramSlice';
// import useOurProgram from '../../hooks/HomeHooks/useOurProgram';
const OpEducation = () => {
  // const dispatch = useDispatch();
  // const ourProgramData = useSelector(selectOurProgramData);
  // const loading = useSelector(selectOurProgramLoading);
  // const error = useSelector(selectOurProgramError);
